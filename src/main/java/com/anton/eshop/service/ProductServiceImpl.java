...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductServiceImpl(ProductRepository productRepository, UserService userService, ItemService itemService, CartService cartService) {
    ...
    public void addUserToCart(String username, Long productId) {
            Cart cart = userService.fetchUserByUsername(username).getCart();
